...
function update() {
  ...
  //link.exit().remove();
      ...
      link = link.data(linkdata, function(d, i) {
      	if (d.source.ein == "943153687" && d.target.ein == "200748404") {
      		//console.log(d.source.ein + "-" + d.target.ein)
      		//console.log(d)
      	}
      	//return i;
      	return d.source.ein + "-" + d.target.ein;})
     //var gg= link.enter().append("g").attr("class", "link")
	...
	console.log(linkg.selectAll(".link"))
	console.log("Path selection:")
	console.log(linkg.selectAll("path"))**/
  ...
  //	console.log(linkg.selectAll(".link"))
      ...
      existing = link = linkg.selectAll(".link")
      	...
      	if ((d.source.name=="American Action Network")&&(d.target.name=="POLITICAL SPENDING")) {
      		//console.log(i)
  				//console.log(d)
  				//console.log(d.source.ein + "-" + d.target.ein)
  			}
  		...
  		.style("stroke-width", function(d) { 
  			if (d.source.name=="American Action Network") {
  				//console.log(d)
  			}	
  			//console.log(d.__data__)
  			//console.log(d)
	...
	/**
	linkg.selectAll(".link").filter(function(d, i) {
		if ((d.source.name=="American Action Network")&&(d.target.name=="POLITICAL SPENDING")) {
		console.log(d)
		}
		return true;
...
/**	
  ...
  text.exit().remove();**/
	...
	console.log(nodeg.selectAll(".node"))**/
