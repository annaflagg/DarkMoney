...
function update() {
    ...
    var linespacetop = 12;
     var linespacebottom = 1;
   
   var text_box = enter.append("text")
      .attr("class", "defaulttext")
  	  .attr("x", function(d) {return d.x+sankey.nodeWidth()/2;})
      .attr("y", function(d) { return d.y -linespacetop; })
      .attr("dy", "0em")
      .attr("text-anchor", "middle")
      .attr("transform", null);
      // .classed("boldtext", function(d) {return permanentname(d);});
    text_box.filter(function(d) { return permanentname(d); })
      .attr("x", function(d) {
      	if (d.name=="Anonymous donators") {
      	return d.x + sankey.nodeWidth() + 5;
      	} else {
      	return d.x - 5;
      	}})
      	.classed("boldtext", function(d) {return permanentname(d);})
      .attr("text-anchor", function(d) {
      	...
      	.attr("y", function(d) { return d.y + d.dy / 2 - linespacetop; });
	...
	text_box.append('tspan')
      ...
      .attr("y", function(d) { return d.y -linespacebottom; })
       .attr("dy", "0em")
      .attr("text-anchor", "middle")
      .attr("transform", null)
       .filter(function(d) { return permanentname(d); })
      .attr("x", function(d) {
      	if (d.name=="Anonymous donators") {
      	return d.x + sankey.nodeWidth() + 5;
      	} else {
      ...
      .attr("text-anchor", function(d) {
      	...
      	.attr("y", function(d) { return d.y + d.dy / 2 - linespacebottom; });
  ...
  .append("xhtml:body")
    ...
    .style("left", 200 + "px")
    .style("top", 400 + "px")
    .html("<p>Lorem <br>ipsum dolor sit amet<p>");**/
...
/**   
   ...
   div
    ...
    enter.append("text")
      ...
      /**
      .text(function(d) { 
      		if (d.name=="American Action Network") {
      		var words = d.name.split(" ");
